			...
			<div class="container ">
				<div class="top-outer clearfix">
					...
					<ul class="top-left">
						...
						<li><a href="mailto:info@example.com"><span class="icon flaticon-letter"></span>info@example.com</a></li>
					</ul>
					...
					<div class="footer-column col-lg-6 col-md-6">
						<div class="footer-widget logo-widget">
							...
							<ul class="list-style-two">
								...
								<li><a href="mailto:info@example.com"><span class="icon flaticon-mail"></span>info@example.com</a></li>
							</ul>
						</div>
					</div>
