<div class="modal" id="modal-new-{{ Str::slug($gestionarServicios->confrmttitl) }}"  role="dialog"
                        ...
                        <div class="form-column col-12">
                            <div class="inner-column  p-4">
                                ...
                                <div class="contact-form">
                                    ...
                                    <div class="form-group row justify-content-md-center administracion">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input required value="3" type="radio" id="new-servicios-contypscod02"
                                                            ...
                                                            class="custom-control-input" />
                                                        <label class="custom-control-label text-white"
                                                            for="new-servicios-contypscod02">Servicio</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
