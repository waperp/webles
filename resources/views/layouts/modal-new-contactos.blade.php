<div class="modal" id="modal-new-{{ Str::slug($gestionarContactos->confrmttitl) }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">NUEVO '{{ Str::upper($gestionarContactos->confrmttitl) }}'</h5>
                        ...
                        <div class="form-column col-12">
                            <div class="inner-column  p-4">
                                ...
                                <div class="contact-form">
                                    <form id="form-new-contactos" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <div class="col-12">
                                                <div class="image-preview mt-2 mb-2">
                                                    ...
                                                    <input class="image-upload" id="new-contactos-confrsvbigi" name="confrsvbigi"
                                                        type="file" />
                                        ...
                                        <input type="hidden" id="new-contactos-confrsscode">
                                        <div class="form-group">
                                            <span class="icon flaticon-send"></span>
                                            <input type="text" id="new-contactos-confrsttitl" name="confrsttitl" placeholder="Titulo">
                                        </div>

                                        <div class="form-group">
                                            <span class="icon flaticon-user-2"></span>
                                            <textarea required id="new-contactos-confrstdesc"  name="confrstdesc" placeholder="Descripcion"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <span class="fa fa-folder"></span>
                                            <select id="select2-new-contactos-confrmsfcod" class="form-control select2-subform w-100" ></select>
                                        </div>
                                        {{-- <div class="form-row">
