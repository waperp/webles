                        ...
                        <div class="form-column col-12">
                            <div class="inner-column  p-4">
                                ...
                                <div class="contact-form">
                                        <form method="post" enctype="multipart/form-data" action="{{ route('secusr.update', Auth::user()
                                        ->secusricode) }}">
                                                @method('PATCH')
                                                @csrf
                                                <div class="row">
                                                        <div class="col-12">
                                                            <div id="edit-perfil-image-preview" class="mt-2 mb-2">
                                                                ...
                                                                <input id="edit-perfil-image-upload" name="hurempvimgh" type="file" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly disabled type="text" value="{{ Auth::user()->secusrtmail }}" name="secusrtmail"
                                                placeholder="Correo Electronico">
                                        </div>

                                        <div class="form-group">
                                            <span class="icon flaticon-user-2"></span>
                                            <input required type="text" name="huremptfnam" value="{{ Auth::user()->employee()->huremptfnam }}" placeholder="Tu Nombre">
                                        </div>
                                        <div class="form-group text-center">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input required value ="1" @if(Auth::user()->employee()->hurempbgend == 1) checked @endif type="radio" id="customRadioInline1" name="hurempbgend"
                                                    class="custom-control-input">
                                                <label class="custom-control-label  text-white"
                                                    for="customRadioInline1">Masculino</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input required value="0" @if(Auth::user()->employee()->hurempbgend == 0) checked @endif type="radio" id="customRadioInline2" name="hurempbgend"
                                                    class="custom-control-input">
                                                <label class="custom-control-label text-white"
